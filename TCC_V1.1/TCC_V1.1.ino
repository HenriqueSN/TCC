...
void loop(){
 ...
 if (t < 37) {
  ...
  entitieID = String(deviceID);

  //começo método
      String bodyRequest = "{ \"pH\": { \"type\": \"float\", \"value\": "+guardaph+" }, \"luminosidade\": { \"type\": \"float\", \"value\": "+guardal+" }, \"tempSolo\": { \"type\": \"float\", \"value\": "+guardats+" }, \"tempAmbiente\": { \"type\": \"float\", \"value\": " + guardat + " }, \"humidSolo\": { \"type\": \"float\", \"value\": "+guardahs+" }, \"humidAmbiente\": { \"type\": \"float\", \"value\": " + guardah + " } } ";
...
//update 
 /* String orionUpdate(String entitieID, String temperature, String humidity, String soilTemperature, String light, String ph, String soilHumidity){
