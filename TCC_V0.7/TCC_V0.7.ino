...
void loop(){
  ...
  orionUpdate(deviceID, guardat, guardah, guardats, guardal);
...
//update 
void orionUpdate(String entitieID, String temperature, String humidity, String soilTemperature, String light){
  
     String bodyRequest = "{ \"pH\": { \"type\": \"float\", \"value\": 20 }, \"luminosidade\": { \"type\": \"float\", \"value\": "+light+" }, \"tempSolo\": { \"type\": \"float\", \"value\": "+soilTemperature+" }, \"tempAmbiente\": { \"type\": \"float\", \"value\": " + temperature + " }, \"humidSolo\": { \"type\": \"float\", \"value\": 20 }, \"humidAmbiente\": { \"type\": \"float\", \"value\": " + humidity + " } } ";
