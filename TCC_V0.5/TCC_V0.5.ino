//conexão com Helix funcionando juntamente com o sensor DHT11
#include <WiFi.h>
...
void loop(){
  ...
  orionUpdate(deviceID, guardat, guardah);
...
void orionUpdate(String entitieID, String temperature, String humidity){
     ...
     String bodyRequest = "{ \"pH\": { \"type\": \"float\", \"value\": 20 }, \"luminosidade\": { \"type\": \"float\", \"value\": 20 }, \"tempSolo\": { \"type\": \"float\", \"value\": 20 }, \"tempAmbiente\": { \"type\": \"float\", \"value\": " + temperature + " }, \"humidSolo\": { \"type\": \"float\", \"value\": 20 }, \"humidAmbiente\": { \"type\": \"float\", \"value\": " + humidity + " } } ";
